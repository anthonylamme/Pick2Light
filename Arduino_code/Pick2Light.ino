...
void turnOffLight(int i) {
  switch (i) {
    case 0: {
        check.digitalWrite(21, LOW,MCP23017_ADDR[0]);
        break;
      }
    case 1: {
        check.digitalWrite(22, LOW,MCP23017_ADDR[0]);
        break;
      }
    case 2: {
        check.digitalWrite(23, LOW,MCP23017_ADDR[0]);
        break;
      }
    case 3: {
        check.digitalWrite(24, LOW,MCP23017_ADDR[0]);
        break;
      }
    case 4: {
        check.digitalWrite(25, LOW,MCP23017_ADDR[0]);
        break;
      }
    case 5: {
        check.digitalWrite(26, LOW,MCP23017_ADDR[0]);
        break;
      }
    case 6: {
        check.digitalWrite(27, LOW,MCP23017_ADDR[0]);
        break;
      }
    case 7: {
        check.digitalWrite(28, LOW,MCP23017_ADDR[0]);
        break;
      }
    case 8: {
        check.digitalWrite(21, LOW,MCP23017_ADDR[1]);
        break;
      }
      
    case 9: {
        check.digitalWrite(22, LOW,MCP23017_ADDR[1]);
        break;
      }
    case 10: {
        check.digitalWrite(23, LOW,MCP23017_ADDR[1]);
        break;
      }
    case 11: {
        check.digitalWrite(24, LOW,MCP23017_ADDR[1]);
        break;
      }
    case 12: {
        check.digitalWrite(25, LOW,MCP23017_ADDR[1]);
        break;
      }
    case 13: {
        check.digitalWrite(26, LOW,MCP23017_ADDR[1]);
        break;
      }
    case 14: {
        check.digitalWrite(27, LOW,MCP23017_ADDR[1]);
        break;
      }
    case 15: {
        check.digitalWrite(28, LOW,MCP23017_ADDR[1]);
        break;
      }
    case 16: {
        check.digitalWrite(21, LOW,MCP23017_ADDR[2]);
        break;
      }
    case 17: {
        check.digitalWrite(22, LOW,MCP23017_ADDR[2]);
        break;
      }
    case 18: {
        check.digitalWrite(23, LOW,MCP23017_ADDR[2]);
        break;
      }
    case 19: {
        check.digitalWrite(24, LOW,MCP23017_ADDR[2]);
        break;
      }
    case 20: {
        check.digitalWrite(25, LOW,MCP23017_ADDR[2]);
        break;
      }
    case 21: {
        check.digitalWrite(26, LOW,MCP23017_ADDR[2]);
        break;
      }
    case 22: {
        check.digitalWrite(27, LOW,MCP23017_ADDR[2]);
        break;
      }
    case 23: {
        check.digitalWrite(28, LOW,MCP23017_ADDR[2]);
        break;
      }
    default: {
